...
{
    /// <inheritdoc />
    public partial class AddConversationSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Conversations_TypeOwner", "([Type] = 0 AND [OwnerId] IS NULL) OR ([Type] = 1 AND [OwnerId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.AddCheckConstraint(
                name: "CK_Messages_Parent",
                table: "Messages",
                sql: "([ChannelId] IS NOT NULL AND [ConversationId] IS NULL) OR ([ChannelId] IS NULL AND [ConversationId] IS NOT NULL)");
